...
class Block(pg.sprite.Sprite):
    ...
    def sfx_end_time(self):
        if self.tetramino.tetris.app.anim_trigger:
    ...
    def is_collide(self, pos):
        ...
        if 0 <= x < FIELD_W and y < FIELD_H and (y < 0 or not self.tetramino.tetris.field_array[y][x]):
            return False
        return True
...
class Tetramino:
    def __init__(self, tetris, current=True):
        ...
        self.blocks = [Block(self, pos) for pos in TETRAMINOES[self.shape]]
        self.landing = False
